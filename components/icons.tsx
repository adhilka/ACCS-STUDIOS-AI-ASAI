...
export const AddFileIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m3.75 9v6m3-3h-6m-1.125-9H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
  </svg>
);

export const AddFolderIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 10.5v6m3-3h-6m-2.25-4.5c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 4.811 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
  </svg>
);
...
// FIX: Completed the SVG path data for the settings icon and removed extraneous code.
export const SettingsIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.223.894c.47.235.924.53 1.341.87l.797-.46a1.125 1.125 0 011.265.313l1.118 1.936a1.125 1.125 0 01-.102 1.39l-.693.8c.038.25.06.504.06.761s-.022.511-.06.76l.693.8a1.125 1.125 0 01.102 1.39l-1.118 1.936a1.125 1.125 0 01-1.265.313l-.797-.46a6.713 6.713 0 01-1.341.87l-.223.894c-.09.542-.56.94-1.11.94h-2.593c-.55 0-1.02-.398-1.11-.94l-.223-.894a6.713 6.713 0 01-1.341-.87l-.797.46a1.125 1.125 0 01-1.265-.313L4.99 16.28a1.125 1.125 0 01-.102-1.39l.693-.8a6.708 6.708 0 01-.06-.76s.022-.511.06-.76l-.693-.8a1.125 1.125 0 01.102-1.39l1.118-1.936a1.125 1.125 0 011.265-.313l.797.46a6.713 6.713 0 011.341-.87l.223-.894zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
    </svg>
);

// FIX: Moved missing icon components here to make them available for import.
...
export const RobotIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 18.75a3 3 0 00-3-3H9a3 3 0 00-3 3h9.75z" />
    </svg>
);
...
export const QuoteIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className={className}>
        <path d="M14.017 21v-7.391c0-2.734 2.21-4.944 4.944-4.944h.023v-3.714h-.023c-4.811 0-8.714 3.903-8.714 8.714v7.332h3.769zm-10.25 0v-7.391c0-2.734 2.21-4.944 4.944-4.944h.023v-3.714h-.023c-4.811 0-8.714 3.903-8.714 8.714v7.332h3.769z"/>
    </svg>
);
...
export const LayersIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.115 5.115A.75.75 0 016 6v12a.75.75 0 01-1.22.607L1.87 14.72a.75.75 0 010-1.214l2.91-3.88a.75.75 0 011.22.607zM17.885 5.115a.75.75 0 01.115-.607l2.91-3.88a.75.75 0 011.22.607v12a.75.75 0 01-.115.607l-2.91 3.88a.75.75 0 01-1.22-.607V5.115z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-4.5m0 0A3.75 3.75 0 0015.75 12H8.25A3.75 3.75 0 0012 16.5zm0 0V21" />
    </svg>
);

export const TargetIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 018.638 5.214m0 0A8.252 8.252 0 0012 3a8.25 8.25 0 003.362 2.214" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75H12a.75.75 0 01-.75-.75v-.008z" />
    </svg>
);

export const BrainIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 13.5c0 1.657 1.343 3 3 3s3-1.343 3-3-1.343-3-3-3-3 1.343-3 3z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2m0 14v2m-7-9H3m18 0h-2m-5 7.77V21m0-18v2.23" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 12c-2 0-2 2-2 2s0-2 2-2z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.5 10.5c.828 0 1.5.672 1.5 1.5s-.672 1.5-1.5 1.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 10.5c-.828 0-1.5.672-1.5 1.5s.672 1.5 1.5 1.5" />
    </svg>
);

export const WrenchScrewdriverIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.474-4.474c-.047-.58-.122-1.193-.266-1.743m-2.5-2.25a2.548 2.548 0 00-3.586-3.586l-6.837 5.63m5.108 .233l2.496 3.03" />
    </svg>
);
...
export const ShareIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.042.582.042h10.948c.552 0 1-.448 1-1s-.448-1-1-1H7.881c-.191.002-.38.017-.564.043zM18.22 12.015c.343.052.68.11.996.175l2.17 1.849a1.125 1.125 0 010 1.942l-2.17 1.849c-.315.065-.653.123-.996.175-1.13.167-2.214.249-3.21.249h-2.118a2.25 2.25 0 01-2.25-2.25v-1.5a2.25 2.25 0 012.25-2.25h2.118c.996 0 2.08.082 3.21.249z" />
    </svg>
);
...
export const CommandLineIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const UsersIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 015.965 0m0 0a3.75 3.75 0 10-5.965 0M12 12.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);

export const DatabaseIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h12A2.25 2.25 0 0120.25 6v12A2.25 2.25 0 0118 20.25H6A2.25 2.25 0 013.75 18V6zM3 13.5h18" />
...
// FIX: Add missing ExclamationTriangleIcon and XCircleIcon
...
export const TokenIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12c0 4.142-3.134 7.5-7 7.5s-7-3.358-7-7.5c0-4.142 3.134-7.5 7-7.5s7 3.358 7 7.5z" />
    </svg>
);
...
export const PaperClipIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3 3 0 1118.374 9.5l-7.693 7.693a1.5 1.5 0 01-2.121-2.121l4.242-4.242" />
    </svg>
);
...
export const RefreshIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.182m-3.181-4.991A8.25 8.25 0 002.985 19.644" />
    </svg>
);

export const ComputerDesktopIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v.007a.375.375 0 01-.375.375H5.25a.375.375 0 01-.375-.375v-.007a.375.375 0 01.375-.375h3.375a.375.375 0 01.375.375zM14.25 17.25v.007a.375.375 0 01-.375.375h-3.375a.375.375 0 01-.375-.375v-.007a.375.375 0 01.375-.375h3.375a.375.375 0 01.375.375zM19.5 17.25v.007a.375.375 0 01-.375.375h-3.375a.375.375 0 01-.375-.375v-.007a.375.375 0 01.375-.375h3.375a.375.375 0 01.375.375zM4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
    </svg>
);
